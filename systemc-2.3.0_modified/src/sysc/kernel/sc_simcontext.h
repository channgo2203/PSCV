...
public:
    ...
    //CHIMP
    void attach_observer(mon_observer* obs);
    mon_observer* get_observer();
    
    //random generator
    void enable_random_scheduler( bool );
    bool is_random_enabled();
...
private:
    ...
    mon_observer*  				  observer; // CHIMP

    bool						        ran_enable; // randomized scheduler is enable
...
// Call this function to initialized the randomized scheduler
extern 
void 
sc_set_random_seed();
